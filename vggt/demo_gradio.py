...
model = VGGT.from_pretrained("../checkpoint/vggt_1b/models--facebook--VGGT-1B/snapshots/860abec7937da0a4c03c41d3c269c366e82abdf9")  # another way to load the model
